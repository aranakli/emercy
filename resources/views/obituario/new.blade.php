                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header">
                            ...
                            Agregar nuevo obituario
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('obituarios.store') }}">
                                @csrf
                                <div class="mb-3">
                                    <label for="id" class="form-label">Id Obituario</label>
                                    <input type="hidden" class="form-control" id="id" aria-describedby="idHelp"
                                        name="id" disabled="disabled">
                                    <div id="idHelp" class="form-text">Id Obituario</div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"  class="form-control" id="nombre"
                                        aria-describedby="nameHelp" name="nombre" required placeholder="Nombre del difunto">
                                </div>
                                <div class="mb-3">
                                    <label for="apellido" class="form-label">Apellido difunto</label>
                                    <input type="text"  class="form-control" id="apellido"
                                        aria-describedby="nameHelp" name="apellido" required placeholder="Apellido del difunto">
                                </div>
                                <div class="mb-3">
                                    <label for="fecha_nacimiento" class="form-label">Fecha de nacimiento del difunto</label>
                                    <input type="date"  class="form-control" id="fecha_nacimiento"
                                        aria-describedby="nameHelp" name="fecha_nacimiento" required placeholder="Fecha de nacimiento del difunto">
                                </div>
                                <div class="mb-3">
                                    <label for="fecha_muerte" class="form-label">Fecha de fallecimiento</label>
                                    <input type="date"  class="form-control" id="fecha_muerte"
                                        aria-describedby="nameHelp" name="fecha_muerte" required placeholder="Fecha de fallecimiento">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local"  class="form-control" id="fecha_exequias"
                                        aria-describedby="nameHelp" name="fecha_exequias" required placeholder="Fecha de exequias">
                                </div>
                                <div class="mb-3">
                                    <label for="lugar_exequias" class="form-label">Lugar de exequias</label>
                                    <input type="text"  class="form-control" id="lugar_exequias"
                                        aria-describedby="nameHelp" name="lugar_exequias" required placeholder="Lugar de exequias">
                                </div>
